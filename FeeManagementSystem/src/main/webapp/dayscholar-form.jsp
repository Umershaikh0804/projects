...
<html>
<head>
<title>Add Scholar Student</title>
...
<body>
    ...
    <div class="glass-panel">
        ...
        <form action="AddStudentServlet" method="post" class="student-form">
            ...
            <input type="hidden" name="student-type" value="dayscholar">

            <div class="form-group">
                <label>State</label> 
                <input type="text" name="state" 
                    value="${sessionScope.state}" required
    ...
    <!-- Add toast styles (same as hostalite-form.jsp) -->
    <style>
        .toast-notification {
            position: fixed;
            top: 30px;
